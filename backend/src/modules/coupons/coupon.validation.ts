...
export type CouponValidationResult =
  | { valid: true; coupon: ICoupon }
  | { valid: false; message: string };

/** Shape needed to compute a discount - accepts a full document or a plain object. */
...
export const calculateDiscount = (coupon: DiscountableCoupon, orderTotal: number): number => {
